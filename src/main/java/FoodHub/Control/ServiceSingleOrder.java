...
public class ServiceSingleOrder {
    public Label mainTitleLBL,usernameLBL,restaurantNameLBL,pathToRestaurantLBL,orderDiscountLBL,orderTotalLBL,addTimeLBL,discriptionLBL,statusLBL,addressLBL;
    ...
    public static ServiceSingleOrder singleOrderController;
    @FXML
    public void initialize() throws IOException
    {
        ...
        usernameLBL.setText("Username: "+te.get(0).user.username);
        restaurantNameLBL.setText("Restaurant Name: "+te.get(0).restaurant.name);
        ...
        path = Map.findPath(userAddress.node, resturantAddress.node).getPath();
        pathToRestaurantLBL.setText("Path to restaurant: " + path);
        ...
        addressLBL.setText("Path To User: "+te.get(0).path);
        //path = path + te.get(0).path;
    ...
    {
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("fxmls/service/serviceSingleOrder.fxml"));
        ServiceSingleOrder.singleOrderController = new ServiceSingleOrder();
        ServiceSingleOrder.singleOrderController.id = id;
        fxmlLoader.setController(ServiceSingleOrder.singleOrderController);
    ...
    {
        ArrayList<Order> te = Main.sql.getAllOrderById(id);
        MapController.show("ServiceSingle",id,path);
